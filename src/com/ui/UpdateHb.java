...
public class UpdateHb extends JFrame {
	...
	public UpdateHb(HbTable t, Hb hba) {
		this.setTitle("修改界面");
		...
		jtf.setText(hba.getHbname());
		jtfc.setText(hba.getGsmc());
		...
		jba.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Hb hb = new Hb(hba.getHbid(), hbname, dj,gsmc);
				int i = new HbDao().update(hb);
				if (i > 0) {
					jtf.setText("");
					jtfc.setText("");
